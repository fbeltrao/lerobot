...
def main():
    ...
    if not keyvault_name or keyvault_name.lower() == "false":
    ...
    if client_id is None:
        ...
        print("AZURE_CLIENT_ID not found, using DEFAULT_IDENTITY_CLIENT_ID", file=sys.stderr)
    ...
    if os.getenv("AZUREML_RUN_ID"):
        try:
            ...
            print(
                f"ManagedIdentityCredential failed: {e}, falling back to DefaultAzureCredential",
                file=sys.stderr,
            )
